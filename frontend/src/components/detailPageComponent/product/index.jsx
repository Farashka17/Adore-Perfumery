...
const Product = () => {
  ...
  return (
    ...
    <div className="container max-w-[1920px] flex flex-col md:flex-row  gap-10 justify-center mx-auto md:px-10 py-[25px] px-[15px] ">

        {/* sol */}
        <div className="container mx-auto overflow-hidden">
      {/* Küçük ekranlar için karusel, büyük ekranlar için grid */}
      <div className="hidden md:block">
        <div className="grid grid-cols-2 gap-5">
          <div>
            <img src={BigPerfume} alt="Perfume" className="w-full h-auto rounded-md" />
          </div>
          <div>
            <img src={BigPerfume} alt="Perfume" className="w-full h-auto rounded-md" />
          </div>
      ...
      <div className="md:hidden overflow-hidden w-full">
        ...
        <div className=''>
            ...
            <div className='flex  w-full gap-3 mt-4'>
                <button className='px-3 border border-[#232323] hover:bg-[#eaeaea] flex  items-center justify-center '> <CiHeart className='w-8 h-8 hover:text-[#dbaf77]'/></button>
