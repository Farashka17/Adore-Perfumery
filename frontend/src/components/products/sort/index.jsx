...
const Sort = () => {
  ...
  return (
    ...
    <div className=" hidden container max-w-[1150px] items-center justify-between md:flex mx-auto px-5 ">
        <div>
            <p className='text-[#232323] font-semibold text-[16px] font-raleway '>Showing 1-9 of 26 results</p>
        </div>
       <div>
    ...
    <div className='flex justify-between items-center md:hidden'>
            ...
            {isVisible && (
                <div className="  md:hidden absolute top-0 left-0 z-10"> {/* absolute ve z-index ekledik */}
                    <Filter/>
                </div>
            )}
